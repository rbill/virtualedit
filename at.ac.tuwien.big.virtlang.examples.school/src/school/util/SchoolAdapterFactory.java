...
public class SchoolAdapterFactory extends AdapterFactoryImpl {
	...
	protected SchoolSwitch<Adapter> modelSwitch =
		new SchoolSwitch<Adapter>() {
			...
			@Override
			public Adapter casePupil(Pupil object) {
				return createPupilAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseGrade2(Grade2 object) {
				return createGrade2Adapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link school.Pupil <em>Pupil</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPupilAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link school.Grade <em>Grade</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link school.Grade2 <em>Grade2</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGrade2Adapter() {
		return null;
	}
