...
public class SchoolSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SchoolPackage.PUPIL: {
				Pupil pupil = (Pupil)theEObject;
				T result = casePupil(pupil);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SchoolPackage.GRADE: {
				Grade grade = (Grade)theEObject;
				T result = caseGrade(grade);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SchoolPackage.GRADE2: {
				Grade2 grade2 = (Grade2)theEObject;
				T result = caseGrade2(grade2);
				if (result == null) result = caseGrade(grade2);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Pupil</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Pupil</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePupil(Pupil object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Grade2</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Grade2</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGrade2(Grade2 object) {
		return null;
	}
