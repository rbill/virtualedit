...
public class SimpleAspectSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (type=Type inType=QualifiedName name=ID)
	 */
	protected void sequence_ForeignAttribute(ISerializationContext context, ForeignAttribute semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SimpleAspectPackage.Literals.FOREIGN_ATTRIBUTE__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SimpleAspectPackage.Literals.FOREIGN_ATTRIBUTE__TYPE));
			if (transientValues.isValueTransient(semanticObject, SimpleAspectPackage.Literals.FOREIGN_ATTRIBUTE__IN_TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SimpleAspectPackage.Literals.FOREIGN_ATTRIBUTE__IN_TYPE));
			if (transientValues.isValueTransient(semanticObject, SimpleAspectPackage.Literals.FOREIGN_ATTRIBUTE__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SimpleAspectPackage.Literals.FOREIGN_ATTRIBUTE__NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getForeignAttributeAccess().getTypeTypeParserRuleCall_1_0(), semanticObject.getType());
		feeder.accept(grammarAccess.getForeignAttributeAccess().getInTypeQualifiedNameParserRuleCall_2_0(), semanticObject.getInType());
		feeder.accept(grammarAccess.getForeignAttributeAccess().getNameIDTerminalRuleCall_4_0(), semanticObject.getName());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (typeName='int' | typeName='double' | typeName='String' | typeName='boolean' | typeRef=QualifiedName)
	 */
