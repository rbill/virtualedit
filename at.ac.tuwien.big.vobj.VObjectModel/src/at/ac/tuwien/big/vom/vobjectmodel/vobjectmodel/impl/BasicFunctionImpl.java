 ...
 * </p>
 * <ul>
 *   <li>{@link at.ac.tuwien.big.vom.vobjectmodel.vobjectmodel.impl.BasicFunctionImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BasicFunctionImpl extends MinimalEObjectImpl.Container implements BasicFunction {
	/**
	...
	protected EClass eStaticClass() {
		return VObjectModelPackage.Literals.BASIC_FUNCTION;
	}
	...
	public EList<ValuePair> getValues() {
		if (values == null) {
			values = new EObjectContainmentEList<ValuePair>(ValuePair.class, this, VObjectModelPackage.BASIC_FUNCTION__VALUES);
		}
		return values;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case VObjectModelPackage.BASIC_FUNCTION__VALUES:
