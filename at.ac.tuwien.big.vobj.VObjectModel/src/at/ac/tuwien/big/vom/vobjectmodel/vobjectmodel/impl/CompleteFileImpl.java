 ...
 * </p>
 * <ul>
 *   <li>{@link at.ac.tuwien.big.vom.vobjectmodel.vobjectmodel.impl.CompleteFileImpl#getVirtModels <em>Virt Models</em>}</li>
 *   <li>{@link at.ac.tuwien.big.vom.vobjectmodel.vobjectmodel.impl.CompleteFileImpl#getInputModels <em>Input Models</em>}</li>
 *   <li>{@link at.ac.tuwien.big.vom.vobjectmodel.vobjectmodel.impl.CompleteFileImpl#getDeltamodel <em>Deltamodel</em>}</li>
 *   <li>{@link at.ac.tuwien.big.vom.vobjectmodel.vobjectmodel.impl.CompleteFileImpl#getLastModelText <em>Last Model Text</em>}</li>
 *   <li>{@link at.ac.tuwien.big.vom.vobjectmodel.vobjectmodel.impl.CompleteFileImpl#getCurrentModelText <em>Current Model Text</em>}</li>
 *   <li>{@link at.ac.tuwien.big.vom.vobjectmodel.vobjectmodel.impl.CompleteFileImpl#getXtextlanguage <em>Xtextlanguage</em>}</li>
 *   <li>{@link at.ac.tuwien.big.vom.vobjectmodel.vobjectmodel.impl.CompleteFileImpl#getEcoredef <em>Ecoredef</em>}</li>
 *   <li>{@link at.ac.tuwien.big.vom.vobjectmodel.vobjectmodel.impl.CompleteFileImpl#getRootObjects <em>Root Objects</em>}</li>
 * </ul>
 *
 * @generated
 */
