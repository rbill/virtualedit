...
public class SampleBurger extends at.ac.tuwien.big.vfunc.nbasic.constraint.SampleEObject implements Citizen.Burger {
	public static final EClass $SampleBurger_CLASS = Citizen.CitizenPackage.eINSTANCE.getBurger();
	public static final EAttribute $Burger_svnr = Citizen.CitizenPackage.eINSTANCE.getBurger_Svnr();
	private ConstantValue<java.lang.String> svnr = new ConstantValue<>(null);
	...
	private ConstantValue<java.lang.String> address = new ConstantValue<>(null);
