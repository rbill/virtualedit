...
public class SampleGrade extends at.ac.tuwien.big.vfunc.nbasic.constraint.SampleEObject implements school.Grade {
	...
	private ConstantValue<school.Course> course = new ConstantValue<>(null);
	...
	private ConstantValue<java.math.BigInteger> grade = new ConstantValue<>(null);
	...
	private ConstantValue<java.math.BigInteger> year = new ConstantValue<>(null);
