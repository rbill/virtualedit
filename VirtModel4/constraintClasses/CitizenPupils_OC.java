...
public class CitizenPupils_OC extends SamplePupil{
	...
	public EClass eClass() {
		...
		static {
		MyResource.putDerivation($CitizenPupils_OC_CLASS,$Pupil_inclass,"cit.address+ ' XYZ'");
		}
	...
	protected void initDerivedProt(){
		...
		{
			OclDerivationEvaluable evaluable = new OclDerivationEvaluable("cit.address+ ' XYZ'", null);
