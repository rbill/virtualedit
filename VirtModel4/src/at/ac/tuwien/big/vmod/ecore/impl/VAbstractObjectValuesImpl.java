...
public abstract class VAbstractObjectValuesImpl implements VObjectValues {

	protected abstract Function<Symbol, ? extends Counter> objectFunction();
	protected abstract Function<Symbol, ? extends Function<String, ? extends Counter>> classFunction();
	protected abstract Function<Symbol, ? extends Function<Symbol, ? extends Counter>> containerFunction();
	
	VEcoreFile ecoreFile;
	protected abstract VModelView modelView();
	...
	protected VAbstractObjectValuesImpl(VEcoreFile ecoreFile) {
	...
	public Iterable<Symbol> getRootObjects() {
		return ()->IteratorUtils.filterType(this.iterator(), (x)->Function.hasValue(containerFunction().getValue(x),MODEL_ROOT));
	}
