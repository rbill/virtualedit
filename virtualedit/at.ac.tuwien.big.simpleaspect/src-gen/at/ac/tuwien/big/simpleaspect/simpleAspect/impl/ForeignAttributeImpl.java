 ...
 *   <li>{@link at.ac.tuwien.big.simpleaspect.simpleAspect.impl.ForeignAttributeImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForeignAttributeImpl extends MinimalEObjectImpl.Container implements ForeignAttribute
{
  ...
  public NotificationChain basicSetExpression(GenericExpression newExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimpleAspectPackage.FOREIGN_ATTRIBUTE__EXPRESSION, oldExpression, newExpression);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExpression(GenericExpression newExpression)
  {
    if (newExpression != expression)
    {
      NotificationChain msgs = null;
      if (expression != null)
        msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SimpleAspectPackage.FOREIGN_ATTRIBUTE__EXPRESSION, null, msgs);
      if (newExpression != null)
        msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SimpleAspectPackage.FOREIGN_ATTRIBUTE__EXPRESSION, null, msgs);
      msgs = basicSetExpression(newExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SimpleAspectPackage.FOREIGN_ATTRIBUTE__EXPRESSION, newExpression, newExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case SimpleAspectPackage.FOREIGN_ATTRIBUTE__EXPRESSION:
