...
public class SimpleAspectSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        AspectExpression aspectExpression = (AspectExpression)theEObject;
        T result = caseAspectExpression(aspectExpression);
        if (result == null) result = caseConstantExpression(aspectExpression);
        if (result == null) result = caseGenericExpression(aspectExpression);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Aspect Expression</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Aspect Expression</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseAspectExpression(AspectExpression object)
  {
    return null;
  }
