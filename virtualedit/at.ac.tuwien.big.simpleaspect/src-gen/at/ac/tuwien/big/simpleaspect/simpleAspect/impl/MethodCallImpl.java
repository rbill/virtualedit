...
public class MethodCallImpl extends StatementImpl implements MethodCall
{
   ...
   * @ordered
   */
  protected ForeignAttribute object;
   ...
   * @generated
   */
  public ForeignAttribute getObject()
  {
    if (object != null && object.eIsProxy())
    {
      InternalEObject oldObject = (InternalEObject)object;
      object = (ForeignAttribute)eResolveProxy(oldObject);
      if (object != oldObject)
      {
   ...
   * @generated
   */
  public ForeignAttribute basicGetObject()
  {
    return object;
  }
   ...
   * @generated
   */
  public void setObject(ForeignAttribute newObject)
  {
    ForeignAttribute oldObject = object;
    object = newObject;
    if (eNotificationRequired())
  ...
  public void eSet(int featureID, Object newValue)
  {
    ...
    {
      case SimpleAspectPackage.METHOD_CALL__OBJECT:
        setObject((ForeignAttribute)newValue);
        return;
      case SimpleAspectPackage.METHOD_CALL__THIS_OBJECT:
  ...
  public void eUnset(int featureID)
  {
    ...
    {
      case SimpleAspectPackage.METHOD_CALL__OBJECT:
        setObject((ForeignAttribute)null);
        return;
      case SimpleAspectPackage.METHOD_CALL__THIS_OBJECT:
