...
import simplejava.Type;

/**
 * This is the item provider adapter for a {@link simplejava.Type} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Type_typeName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Type_typeName_feature", "_UI_Type_type"),
				 SimplejavaPackage.Literals.TYPE__TYPE_NAME,
				 true,
				 false,
				 false,
	...
	protected void addTypeRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Type_typeRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Type_typeRef_feature", "_UI_Type_type"),
				 SimplejavaPackage.Literals.TYPE__TYPE_REF,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Type)object).getTypeName();
