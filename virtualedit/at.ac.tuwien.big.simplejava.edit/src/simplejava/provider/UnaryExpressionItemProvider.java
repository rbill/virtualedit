...
import simplejava.UnaryExpression;

/**
 * This is the item provider adapter for a {@link simplejava.UnaryExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnaryExpressionItemProvider extends GenericExpressionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimplejavaPackage.Literals.UNARY_EXPRESSION__TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimplejavaPackage.Literals.UNARY_EXPRESSION__SOURCE);
		}
	...
	public String getText(Object object) {
		String label = ((UnaryExpression)object).getType();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimplejavaPackage.Literals.UNARY_EXPRESSION__SOURCE,
