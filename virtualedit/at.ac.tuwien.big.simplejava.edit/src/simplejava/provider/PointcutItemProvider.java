...
/**
 * This is the item provider adapter for a {@link simplejava.Pointcut} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PointcutItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimplejavaPackage.Literals.POINTCUT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimplejavaPackage.Literals.POINTCUT__PARAMETER);
			childrenFeatures.add(SimplejavaPackage.Literals.POINTCUT__CONDITION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Pointcut.class)) {
			case SimplejavaPackage.POINTCUT__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case SimplejavaPackage.POINTCUT__PARAMETER:
			case SimplejavaPackage.POINTCUT__CONDITION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimplejavaPackage.Literals.POINTCUT__PARAMETER,
				 SimplejavaFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(SimplejavaPackage.Literals.POINTCUT__CONDITION,
