...
/**
 * This is the item provider adapter for a {@link simplejava.VariableExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableExpressionItemProvider extends GenericExpressionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimplejavaPackage.Literals.VARIABLE_EXPRESSION__VARIABLE,
				 true,
				 false,
				 true,
				 null,
