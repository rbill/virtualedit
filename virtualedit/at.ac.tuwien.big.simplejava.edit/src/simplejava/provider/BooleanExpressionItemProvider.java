...
/**
 * This is the item provider adapter for a {@link simplejava.BooleanExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanExpressionItemProvider extends ConstantExpressionItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimplejavaPackage.Literals.BOOLEAN_EXPRESSION__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_BooleanExpression_type") + " " + booleanExpression.isValue();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BooleanExpression.class)) {
			case SimplejavaPackage.BOOLEAN_EXPRESSION__VALUE:
