...
public class SimpleDeltaIntegerValueElementListening<U1,U2> extends at.ac.tuwien.big.vmodel.general.impl.SimpleDeltaIntegerValueElement<U1,U2> implements at.ac.tuwien.big.virtmod.structure.VListeningProperty<SimpleDeltaIntegerValueElementListener<U1,U2>> {

	java.util.WeakHashMap<SimpleDeltaIntegerValueElementListener<U1,U2>,Boolean> $listeners = new java.util.WeakHashMap<>();

	public void addIncompleteListener(at.ac.tuwien.big.virtmod.structure.VListener listener ) {
		$listeners.put(listener.fullyImplement(SimpleDeltaIntegerValueElementListener.class),true);
	}

	public void addListener(SimpleDeltaIntegerValueElementListener<U1,U2> listener ) {
