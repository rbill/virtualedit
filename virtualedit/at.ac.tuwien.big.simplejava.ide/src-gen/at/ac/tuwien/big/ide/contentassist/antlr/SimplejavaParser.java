		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTypeAccess().getIsVoidAssignment_1(), "rule__Type__IsVoidAssignment_1");
					put(grammarAccess.getTypeAccess().getTypeRefAssignment_2(), "rule__Type__TypeRefAssignment_2");
