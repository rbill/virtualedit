...
public class SimplejavaStandaloneSetupGenerated implements ISetup {
	...
	public void register(Injector injector) {
		...
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("vjava", resourceFactory);
		IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("vjava", serviceProvider);
	}
}
