...
public class SimplejavaParser extends AbstractContentAssistParser {
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getClassDeclarationAccess().getAttributeAssignment_4_0_0(), "rule__ClassDeclaration__AttributeAssignment_4_0_0");
					put(grammarAccess.getClassDeclarationAccess().getMethodAssignment_4_1(), "rule__ClassDeclaration__MethodAssignment_4_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalSimplejavaParser typedParser = (InternalSimplejavaParser) parser;
			typedParser.entryRuleSimpleJava();
