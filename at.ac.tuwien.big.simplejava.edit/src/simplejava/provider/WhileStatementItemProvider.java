...
import simplejava.WhileStatement;

/**
 * This is the item provider adapter for a {@link simplejava.WhileStatement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WhileStatementItemProvider extends StatementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimplejavaPackage.Literals.WHILE_STATEMENT__CONDITION);
			childrenFeatures.add(SimplejavaPackage.Literals.WHILE_STATEMENT__BODY);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(WhileStatement.class)) {
			case SimplejavaPackage.WHILE_STATEMENT__CONDITION:
			case SimplejavaPackage.WHILE_STATEMENT__BODY:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimplejavaPackage.Literals.WHILE_STATEMENT__CONDITION,
				 SimplejavaFactory.eINSTANCE.createParanthesisOrBinaryExpression()));

		newChildDescriptors.add
			(createChildParameter
				(SimplejavaPackage.Literals.WHILE_STATEMENT__BODY,
