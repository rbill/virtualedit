...
import simplejava.Method;
import simplejava.SimplejavaFactory;
import simplejava.SimplejavaPackage;

/**
 * This is the item provider adapter for a {@link simplejava.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimplejavaPackage.Literals.METHOD__STATIC,
				 true,
				 false,
				 false,
	...
	protected void addGeneratedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_generated_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_generated_feature", "_UI_Method_type"),
				 SimplejavaPackage.Literals.METHOD__GENERATED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SimplejavaPackage.Literals.METHOD__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimplejavaPackage.Literals.METHOD__RETURN_TYPE);
			childrenFeatures.add(SimplejavaPackage.Literals.METHOD__PARAMETER);
			childrenFeatures.add(SimplejavaPackage.Literals.METHOD__CONTENT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Method.class)) {
			case SimplejavaPackage.METHOD__STATIC:
			case SimplejavaPackage.METHOD__GENERATED:
			case SimplejavaPackage.METHOD__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case SimplejavaPackage.METHOD__RETURN_TYPE:
			case SimplejavaPackage.METHOD__PARAMETER:
			case SimplejavaPackage.METHOD__CONTENT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimplejavaPackage.Literals.METHOD__RETURN_TYPE,
				 SimplejavaFactory.eINSTANCE.createType()));

		newChildDescriptors.add
			(createChildParameter
				(SimplejavaPackage.Literals.METHOD__PARAMETER,
				 SimplejavaFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add
			(createChildParameter
				(SimplejavaPackage.Literals.METHOD__CONTENT,
